...
public class Main {
	...
	private void initialize() {
		...
		String path = "C:\\Users\\SMHRD\\Desktop\\before_login.jpg";//메인 이미지
...
//					JOptionPane.showMessageDialog(null, "가입된 회원이 아닙니다.", "로그인", JOptionPane.WARNING_MESSAGE);
//					txt_id.setText("");
//					txt_pw.setText("");
//				} else if (idresult == false) {					
//					JOptionPane.showMessageDialog(null, "아이디를 다시 입력하세요.", "아이디", JOptionPane.WARNING_MESSAGE);
//					txt_id.setText("");
//				} else if(pwresult == false) {
//					JOptionPane.showMessageDialog(null, "비밀번호를 다시 입력하세요.", "비밀번호", JOptionPane.INFORMATION_MESSAGE);
//					txt_pw.setText("");
//				} 
